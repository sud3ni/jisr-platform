...
import { deleteInstitution } from "@/app/dashboard/admin/institutions/[id]/actions";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <p className="mb-4 leading-7 text-gray-700">
              هل أنت متأكد من رغبتك في حذف المؤسسة:
            </p>
            ...
            <div className="rounded-lg bg-red-50 p-4 text-sm leading-6 text-red-700">
              ⚠️ هذا الإجراء سيحذف سجل المؤسسة من قاعدة البيانات.
              لا يمكن التراجع عن العملية بعد تنفيذها.
            </div>
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              >
                {loading ? "جاري الحذف..." : "نعم، احذف المؤسسة"}
              </button>
